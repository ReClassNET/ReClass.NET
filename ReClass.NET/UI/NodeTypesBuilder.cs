...
namespace ReClassNET.UI
{
	internal static class NodeTypesBuilder
	{
		...
		static NodeTypesBuilder()
		{
			...
			defaultNodeTypeGroupList.Add(new[] { typeof(IntPtrNode), typeof(Int64Node), typeof(Int32Node), typeof(Int16Node), typeof(Int8Node) });
			defaultNodeTypeGroupList.Add(new[] { typeof(UIntPtrNode), typeof(UInt64Node), typeof(UInt32Node), typeof(UInt16Node), typeof(UInt8Node) });
