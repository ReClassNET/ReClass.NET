...
namespace ReClassNET.UI
{
	public static class NodeTypesBuilder
	{
		...
		static NodeTypesBuilder()
		{
			...
			defaultNodeTypeGroupList.Add(new[] { typeof(PointerNode), typeof(BaseWrapperArrayNode), typeof(ClassInstanceArrayNode), typeof(ClassPtrArrayNode), typeof(VTableNode), typeof(FunctionNode), typeof(FunctionPtrNode) });
		}
