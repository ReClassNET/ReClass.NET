...
namespace ReClassNET.Nodes
{
	public class UInt64Node : BaseNumericNode
	{
		...
		public override void Update(HotSpot spot)
		{
			...
			{
				if (ulong.TryParse(spot.Text, out var val) || spot.Text.TryGetHexString(out var hexValue) && ulong.TryParse(hexValue, NumberStyles.HexNumber, CultureInfo.CurrentCulture, out val))
				{
