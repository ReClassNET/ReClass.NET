...
namespace ReClassNET.Nodes
{
	public class UInt8Node : BaseNumericNode
	{
		...
		public override void Update(HotSpot spot)
		{
			...
			{
				if (byte.TryParse(spot.Text, out var val) || spot.Text.TryGetHexString(out var hexValue) && byte.TryParse(hexValue, NumberStyles.HexNumber, CultureInfo.CurrentCulture, out val))
				{
