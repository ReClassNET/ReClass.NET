...
namespace ReClassNET.Nodes
{
	public class Matrix3x4Node : BaseMatrixNode
	{
		...
		private readonly struct Matrix3x4Data
		{
			[FieldOffset(0)]
		...
		{
			return DrawMatrixType(context, x2, y2, "Matrix (3x4)", (int defaultX, ref int maxX, ref int y) =>
			{
				var value = context.Memory.ReadObject<Matrix3x4Data>(Offset);
