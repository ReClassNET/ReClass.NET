namespace ReClassNET.Forms
{
	partial class SettingsForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.nodeHexValueColorBox = new ReClassNET.UI.PropertyBindableColorBox();
			this.nodePluginColorBox = new ReClassNET.UI.PropertyBindableColorBox();
			this.nodeHexValueLabel = new System.Windows.Forms.Label();
			this.nodeVTableLabel = new System.Windows.Forms.Label();
			this.nodeOffsetColorBox = new ReClassNET.UI.PropertyBindableColorBox();
			this.nodeVTableColorBox = new ReClassNET.UI.PropertyBindableColorBox();
			this.nodeOffsetLabel = new System.Windows.Forms.Label();
			this.nodeTextLabel = new System.Windows.Forms.Label();
			this.nodeAddressColorBox = new ReClassNET.UI.PropertyBindableColorBox();
			this.nodeTextColorBox = new ReClassNET.UI.PropertyBindableColorBox();
			this.nodeAddressLabel = new System.Windows.Forms.Label();
			this.nodeCommentLabel = new System.Windows.Forms.Label();
			this.nodeHiddenColorBox = new ReClassNET.UI.PropertyBindableColorBox();
			this.nodeCommentColorBox = new ReClassNET.UI.PropertyBindableColorBox();
			this.nodeHiddenLabel = new System.Windows.Forms.Label();
			this.nodeIndexLabel = new System.Windows.Forms.Label();
			this.nodeSelectedColorBox = new ReClassNET.UI.PropertyBindableColorBox();
			this.nodeIndexColorBox = new ReClassNET.UI.PropertyBindableColorBox();
			this.nodeSelectedLabel = new System.Windows.Forms.Label();
			this.nodeTypeColorBox = new ReClassNET.UI.PropertyBindableColorBox();
			this.nodeValueColorBox = new ReClassNET.UI.PropertyBindableColorBox();
			this.nodeTypeLabel = new System.Windows.Forms.Label();
			this.nodeNameLabel = new System.Windows.Forms.Label();
			this.nodeNameColorBox = new ReClassNET.UI.PropertyBindableColorBox();
    ...
    "e, they will automatically be opened by ReClass.NET.";
		...
		private UI.PropertyBindableColorBox nodeHiddenColorBox;
		private System.Windows.Forms.Label nodeAddressLabel;
		private UI.PropertyBindableColorBox nodeAddressColorBox;
		private System.Windows.Forms.Label nodeOffsetLabel;
		private UI.PropertyBindableColorBox nodeOffsetColorBox;
		private System.Windows.Forms.Label nodeHexValueLabel;
		private UI.PropertyBindableColorBox nodeHexValueColorBox;
		private System.Windows.Forms.Label backgroundLabel;
		private System.Windows.Forms.Label nodeValueLabel;
		private UI.PropertyBindableColorBox nodeValueColorBox;
		private System.Windows.Forms.Label nodeNameLabel;
		private UI.PropertyBindableColorBox nodeNameColorBox;
		private System.Windows.Forms.Label nodeTypeLabel;
		private UI.PropertyBindableColorBox nodeTypeColorBox;
		private System.Windows.Forms.Label nodeVTableLabel;
		private UI.PropertyBindableColorBox nodeVTableColorBox;
		private System.Windows.Forms.Label nodeTextLabel;
		private UI.PropertyBindableColorBox nodeTextColorBox;
		private System.Windows.Forms.Label nodeCommentLabel;
		private UI.PropertyBindableColorBox nodeCommentColorBox;
		private System.Windows.Forms.Label nodeIndexLabel;
		private UI.PropertyBindableColorBox nodeIndexColorBox;
